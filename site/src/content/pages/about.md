...
I'm Patrik Goorts, a computer vision engineer based in Belgium. Give me a problem and I'll figure out how to solve it, solve it, and deploy it. I work independently and don't need handholding.
...
* **Camera calibration:** Many of my projects used multiple cameras, and we need to know where the cameras are. I mainly used feature detection, bundle adjustment, and sensor fusion for the extrinsic calibration, and the checkerboard method of Zhang. Either in OpenCV or Colmap
...
* **Move it around:** For fast processing and direct control, I typically use video and audio encoder and decoders directly, instead of relying on GStreamer or ffmpeg. This also helped me understand the specifics of video encoding and decoding.
...
* **Technical writing:** Many of my projects have been reported and documented in conference papers, journal articles, deliverable reports, pull requests, bug reports, and so on. Especially with innovative technologies, clear and useful reporting is equally as important as deployment to users.
...
* **Libraries and frameworks:** OpenCV, PyTorch with matplotlib, Unity 3D, Comfy UI
